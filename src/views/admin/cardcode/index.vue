...
import { CardCodeList } from '@/api/admin/cardCodeApi.js'
import { CreateCardCodeOrder } from '@/api/admin/cardCodeOrderApi.js'
export default {
	name: 'cardcode',
	components: {},
	data() {
		...
		return {
			...
			creteCodeStr: '',
			uploadAction: 'https://yfdcallbacktest.comzt.cn:30080/api/UploadFile/Image',
